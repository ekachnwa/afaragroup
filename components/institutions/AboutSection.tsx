      ...
      <div className="mx-auto grid max-w-7xl gap-16 px-6 lg:grid-cols-3">
        ...
        <div className="lg:col-span-2">
          ...
          <p className="mt-6 text-lg leading-8 text-slate-600">
            Afarawings Aero College is dedicated to delivering high-quality
            aviation education that meets international standards. We combine
            expert instruction, advanced technology, and hands-on training to
            develop skilled, competent, and safety-conscious aviation
            professionals.
          </p>
