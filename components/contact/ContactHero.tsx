...
export default function ContactHero({title, highlightedText, subtitle}) {
  return (
        ...
        <div>
          ...
          <div className="mt-10 flex flex-wrap gap-4">
            ...
            <PrimaryHeroButtons
              ...
              primaryButtonLink='tel:+234 700 123 4567'
            ...
            secondaryButtonLink='mailto:info@afaragroup.com.ng'
